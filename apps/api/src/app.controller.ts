...
export class AppController {
  ...
  @Post("projects/:projectId/short-film/golden-scene/professional-30s/approve-budget")
  approveProfessionalGoldenSceneBudget(@Param("projectId") projectId: string, @Body() body: unknown) {
