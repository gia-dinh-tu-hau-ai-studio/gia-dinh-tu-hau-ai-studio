...
const request = {
  ...
  provider_budget: {
    ...
    estimate: { basis_version: "TUHAUAI_BUDGET_2026-08-09" as const, estimated_duration_seconds: 60, currency: "USD" as const, script: 1, video: 0, voice: 0, lip_sync: 0, contingency: 0, total: 1 },
